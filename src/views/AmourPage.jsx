...
export default function AmourPage() {
  ...
  return (
    <div style={{ margin: '-24px -16px' }}>
      ...
      {/* ── TABS ── */}
      <div style={{ background: '#FFF4F7', paddingTop: 20, paddingBottom: 28, paddingLeft: 'clamp(32px,5vw,80px)', paddingRight: 'clamp(32px,5vw,80px)', borderBottom: '1px solid rgba(102,10,67,0.08)' }}>
