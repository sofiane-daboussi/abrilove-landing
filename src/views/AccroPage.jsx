      ...
      <div className="card">
        ...
        <div className="payment-block fade-section" ref={paiementRef} id="paiement">
          ...
          <div className="payment-book-row">
            ...
            <img src="/images/accro-cover.avif" alt="Accro aux mauvais hommes" className="payment-book-img" width="72" loading="lazy" />
          </div>
            ...
            <>
              ...
              <div className={`order-bump${addBump ? ' selected' : ''}`} onClick={() => setAddBump(v => !v)}>
                ...
                <div className="order-bump-row">
                  ...
                  <img src="/images/dating.avif" alt="Applis de rencontre" className="order-bump-img" width="52" height="68" loading="lazy" />
                </div>
              </div>
              ...
              <div className={`order-bump${addBump2 ? ' selected' : ''}`} onClick={() => setAddBump2(v => !v)}>
                ...
                <div className="order-bump-row">
                  ...
                  <img src="/images/ghosting.avif" alt="Tu t'es encore fait ghoster" className="order-bump-img" width="52" height="68" loading="lazy" />
                </div>
              </div>
